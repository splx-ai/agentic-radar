...
class Node(BaseModel):
    ...
    category: Optional[NodeCategory] = Field(None, description="Category of the tool (only for Tool nodes)")

class Edge(BaseModel):
    start_node: str = Field(..., description="Label of the starting node")
    end_node: str = Field(..., description="Label of the end node")
    condition: Optional[str] = Field(None, description="Optional condition for the edge")